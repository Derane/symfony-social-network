...
class MicroPostRepository extends ServiceEntityRepository
{
    ...
    {
        $this->findAllQuery(withComments: true, withLikes: true, withAuthors: true)->where('p.author = :author')
            ->setParameter('author', $author instanceof User ? $author->getId() : $author)
            ->getQuery()->getResult();
    }

    private function findAllQuery(bool $withComments = false, bool $withLikes = false,
                                  bool $withAuthors = false, bool $withProfiles = false): QueryBuilder
    {
