...
return [
    ...
    [ // $staticRoutes
        ...
        '/new123' => [[['_route' => 'new123', '_controller' => 'App\\Controller\\NewController::index'], null, null, null, false, false, null]],
    ],
    [ // $regexpList
        0 => '{^(?'
                .'|/_error/(\\d+)(?:\\.([^/]++))?(*:35)'
    ...
    [ // $dynamicRoutes
        ...
        55 => [
            [['_route' => 'app_one', '_controller' => 'App\\Controller\\OneController::index'], ['id'], null, null, false, true, null],
